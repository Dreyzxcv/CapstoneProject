                    ...
                    <div>
                        ...
                        <div className="overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
                            <div className="overflow-x-auto">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        ...
                                        {jevs.data.map((jev) => (
                                            <tr key={jev.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-3 text-right">
                                                    <Link
                                                        href={route('assets.jev.show', { asset: jev.asset_id, type: jev.asset_type })}
                                ...
                                {jevs.last_page > 1 && (
                                    <div className="flex items-center justify-between border-t border-gray-200 px-4 py-3 text-sm text-gray-500 min-w-0">
