...
<div class="label-page">
    <table class="header-row">
        <tr>
            ...
            <td class="org-cell">
                ...
                <p class="org-subtitle">Asset Tracking &middot; ForesTrack</p>
            </td>
        </tr>
    </table>
    ...
    <p class="footer-note">Scan the QR code to view the live asset record. System-generated by ForesTrack.</p>
</div>
@endforeach
