...
@for ($piece = 1; $piece <= $totalPieces; $piece++)
<div class="label-page">
    ...
    <div class="piece-badge">PIECE {{ $piece }} / {{ $totalPieces }}</div>
    ...
    <table class="item-table">
        ...
        <tr><th>Species</th><td>{{ $asset->species ?: '—' }}</td></tr>
        <tr>
            <th>Dimension</th>
            <td>
                @if($asset->type->value === 'log' && $asset->length && $asset->width && $asset->height)
                    {{ $asset->length }} &times; {{ $asset->width }} &times; {{ $asset->height }}
                @elseif($asset->volume_bd_ft)
